...
# DRAW -> take the top discard, ACTION + one selected card -> throw that card and end turn.
...
text = text.replace('v0.0.10 • COMBOS + TABLE TACTILE', 'v0.0.11 • DÉFAUSSE TACTILE + TABLE XL')
text = text.replace(
